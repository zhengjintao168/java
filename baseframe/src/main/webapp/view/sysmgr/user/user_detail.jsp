    ...
    <div class="bootbox-body">
        ...
        <form id="detailUserForm" action="${baseURL}/sysmgr/user/updateUser" class="form-horizontal">
            ...
            <div class="form-group">
                ...
                <div class="col-md-8 col-sm-8 detail-content">${user.nickname}</div>
            </div>

            <div class="form-group">
                <label class="col-md-3 col-sm-3 control-label">登录账号：</label>
                <div class="col-md-8 col-sm-8 detail-content">${user.account}</div>
            </div>

            <div class="form-group">
                <label class="col-md-3 col-sm-3 control-label">手机号码：</label>
                <div class="col-md-8 col-sm-8 detail-content">${user.phone}</div>
            </div>

            <div class="form-group">
                <label class="col-md-3 col-sm-3 control-label">组织机构：</label>
                <div class="col-md-8 col-sm-8 detail-content">${user.orgName}</div>
            </div>
