...
(function (factory) {
    ...
    //bootstrap对多级模态框支持有bug , 因此去掉缩放/全屏等图片浏览方式
    ...
    defaultPreviewSettings = {
        image: {width: "160px", height: "auto"},           //固定宽度 image: {width: "auto", height: "160px"},
    ...
    $.fn.fileinput = function (option) {
        ...
        this.each(function () {
            var self = $(this), data = self.data('fileinput'), options = typeof option === 'object' && option,
                ...
                lang = 'zh', opts;  //暂时写死为中文 , options.language || self.data('language') || 'en', opts;
            if (!data) {
                if (theme) {
